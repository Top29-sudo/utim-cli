...
- Free-tier and paid-tier model routing.
...
- `generate_3d_model`: generates 3D assets (GLB/OBJ), rigs, or animates them via Tripo AI API.

Default disabled tools include `generate_3d_model` until enabled.
